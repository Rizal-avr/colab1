            ...
            <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
                <div class="modal-content radius-16 bg-base">
                    ...
                    <div class="modal-body p-24">
                        <form id="formTambahpembelian" action="{{ route('pembelian.store') }}" method="POST">
                            @csrf
                            <div class="row">
                ...
                <table id="studentTable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="h6 mb-0 fw-medium text-gray-300">{{ $pembelians->mitra->nama_mitra }}</span>
                            </td>
                            <td>
                                <span class="h6 mb-0 fw-medium text-gray-300">{{ $pembelians->sayur->nama_sayur }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="#" data-bs-toggle="modal" data-bs-target="#detailpetaniModal-{{ $pembelians->id_mitra }}"

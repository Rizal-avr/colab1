            ...
            <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
                <div class="modal-content radius-16 bg-base">
                    ...
                    <div class="modal-body p-24">
                        <form id="formTambahpetani" action="{{ route('petani.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12 mb-20">
                                    <label
                                        for="nama_mitra" class="form-label fw-semibold text-primary-light text-sm mb-8">Nama petani : </label>
                ...
                <table id="studentTable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="h6 text-gray-300">Nama petani</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" data-bs-toggle="modal" data-bs-target="#detailpetaniModal-{{ $mitras->id_mitra }}"
                        ...
                        <!-- Modal Add Event -->
                        <div class="modal fade" id="detailpetaniModal-{{ $mitras->id_mitra }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
                                <div class="modal-content radius-16 bg-base">
                                    <div
                                    ...
                                    <div class="modal-body p-24">
                                        <form id="formUpdateStatus-{{ $mitras->id_mitra }}" method="POST"
                                            action="{{ route('petani.update', $mitras->id_mitra) }}">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                <div class="col-12 mb-20">
                                                    <label
                                                        class="form-label fw-semibold text-primary-light text-sm mb-8">Nama petani</label>

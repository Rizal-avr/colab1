                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-24 max-h-270 overflow-y-auto scroll-sm">
                                    <div class="d-flex align-items-start gap-12">
                                        <img src="{{asset('assets/images/thumbs/notification-img1.png')}}" alt=""
                                    ...
                                    <div class="d-flex align-items-start gap-12">
                                        <img src="{{asset('assets/images/thumbs/notification-img2.png')}}" alt=""
                                            class="w-48 h-48 rounded-circle object-fit-cover">
                                        <div class="">
                                            <a href="#"
                                ...
                                <div class="max-h-270 overflow-y-auto scroll-sm pe-8">
                                    <div
                                        ...
                                        <label
                                            ...
                                            <span
                                                ...
                                                <img src="{{asset('assets/images/thumbs/flag1.png')}}" alt=""
                                    ...
                                    <div
                                        ...
                                        <label
                                            ...
                                            <span
                                                class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-8">
                                                <img src="{{asset('assets/images/thumbs/flag2.png')}}" alt=""
                                                    class="w-32-px h-32-px border borde border-gray-100 rounded-circle flex-shrink-0">
                                    ...
                                    <div
                                        ...
                                        <label
                                            ...
                                            <span
                                                class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-8">
                                                <img src="{{asset('assets/images/thumbs/flag3.png')}}" alt=""
                                                    class="w-32-px h-32-px border borde border-gray-100 rounded-circle flex-shrink-0">
                                    ...
                                    <div
                                        ...
                                        <label
                                            ...
                                            <span
                                                class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-8">
                                                <img src="{{asset('assets/images/thumbs/flag4.png')}}" alt=""
                                                    class="w-32-px h-32-px border borde border-gray-100 rounded-circle flex-shrink-0">
                ...
                <table id="studentTable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="h6 text-gray-300">Username</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-align gap-8">
                                    <img src="{{asset('assets/images/thumbs/student-img2.png')}}" alt=""
                                        class="w-40 h-40 rounded-circle">
                                    <span class="h6 mb-0 fw-medium text-gray-300">{{ $users->username }}</span>
                                </div>
                            </td>
                            <td>
                                <span class="h6 mb-0 fw-medium text-gray-300">{{$users->password}}</span>
                            </td>
                            <td>
                                <span class="h6 mb-0 fw-medium text-gray-300">{{ $users->role }}</span>
                            </td>
                            <td>
                                <a href="#"
